        ...
        <>
            ...
            <div className="h-screen w-screen p-0 m-0 bg-white max-h-screen flex">
                ...
                <Tooltip title={ strings.app.tooltipMenuButton }>
                    <div
                        className={ `hidden md:flex absolute ${ isMobile ? "bottom-5" : "top-2" } left-0 translate-x-1/2 z-10 p-1 bg-ukraine-blue hover:brightness-105 cursor-pointer rounded-lg drop-shadow-md` }
